...
EOF
    ...
    public function testEach()
    {
        ...
        $this->assertEquals(array('0-One', '1-Two', '2-Three'), $data, '->each() executes an anonymous functions on each node of the list');
    }
...
<body>
    <div id="action">
        <a href="/OrderCentre.php?r=site/login">Login</a>
    </div>
    <form id="login-form" action="/OrderCentre.php?r=site/login" method="post">
