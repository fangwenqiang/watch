 ...
 * languages (usually, just replace the include name and the functions name).
 *
 ...
 * phorum_htmlpurifier_migrate() functions. You still need migrate.php
...
/**
 * 'format' hook style functions that will be called to convert
