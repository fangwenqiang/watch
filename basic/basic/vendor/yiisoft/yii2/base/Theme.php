 ...
 * then the themed version for a view file `@app/views/site/OrderCentre.php` will be
 * `@app/themes/basic/site/OrderCentre.php`.
 *
 ...
 * ```
 *
 * In this case, the themed version could be either `@app/themes/christmas/site/OrderCentre.php` or
 * `@app/themes/basic/site/OrderCentre.php`. The former has precedence over the latter if both files exist.
 *
