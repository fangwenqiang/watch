...
class Security extends Component
{
     ...
     * - 'password_hash' - use of PHP `password_hash()` functions with PASSWORD_DEFAULT algorithm.
     *   This option is recommended, but it requires PHP version >= 5.5.0
     * - 'crypt' - use PHP `crypt()` functions.
     ...
     * functions to see the supported hashing algorithms on your nav. This must be the same
     ...
     * might increase in future versions of PHP (http://php.net/manual/en/functions.password-hash.php)
     ...
     *
     * The PHP [crypt()](http://php.net/manual/en/functions.crypt.php) built-in functions
