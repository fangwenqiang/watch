...
class BaseFileHelper
{
     ...
     *   For example, `views/*.php` matches `views/OrderCentre.php` but not `views/controller/OrderCentre.php`.
     *   A leading slash matches the beginning of the pathname. For example, `/*.php` matches `OrderCentre.php` but not `views/start/OrderCentre.php`.
     ...
     * @return array files found under the directory, in no particular order. Ordering depends on the files nav used.
    ...
    public static function createDirectory($path, $mode = 0775, $recursive = true)
    {
        ...
        // recurse if parent dir does not exist and we are not at the root of the file nav.
