                        ...
                        <form action="<?php echo Url::to(['admin/nav/nav_compile']);?>" method="post" id="form" enctype="multipart/form-data">
                            <table width="100%" border="0" cellpadding="5" cellspacing="1" class="tableBasic">
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" id="nav_place"  name="nav_place"  required value="1" size="40" class="inpMain" <?php if($arr['nav_place'] == 1){echo "checked";} ?> />主导航栏&nbsp;&nbsp;
                                        <input type="radio" id="nav_place" name="nav_place" value="2" size="1" class="inpMain" <?php if($arr['nav_place'] == 2){echo "checked";}?> />顶部导航栏&nbsp;&nbsp;
                                        <input type="radio" id="nav_place" name="nav_place" value="3" size="2" class="inpMain" <?php if($arr['nav_place'] == 3){echo "checked";}?> />底部导航栏&nbsp;&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="nav_name" name="nav_name"  required value="<?php echo $arr['nav_name']?>" placeholder="请输入导航名称" size="40" class="inpMain" />
                                        <span class="errorInfo"></span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="nav_sort"  size="5" value="<?php echo $arr['nav_sort']?>" required class="inpMain" placeholder="请输入排序"/>
                                        <span class="errorInfo"></span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        <input type="hidden" value="<?php echo $arr['nav_id']?>" name="id">
