...
<div id="dcMain">
    ...
    <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        ...
        <form action="<?php echo Url::to(['admin/coupon/update'])?>" method="post" enctype="multipart/form-data">
            <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                <tr>
                    <td width="80" align="right">优惠券名称</td>
                    <td>
                        <input type="text" name="coupon_name" value="<?php echo $coupon['coupon_name']?>" size="40" class="inpMain" required=""/>
                    </td>
                </tr>
                <tr>
                    <td align="right">优惠券编号</td>
                    <td>
                        <input type="text" name="coupon_sn" size="40"  value="<?php echo $coupon['coupon_sn']?>" class="inpMain" /> <span style="color: orange;">* </span> 不写系统自动生成
                    </td>
                </tr>
                <tr>
                    <td width="80" align="right">面值</td>
                    <td>
                        <input type="text" name="coupon_value" value="<?php echo $coupon['coupon_value']?>" size="20" class="inpMain" required=""/>
                    </td>
                </tr>
                <input name="coupon_id" type="hidden" id="coupon_id" value="<?php echo $coupon['coupon_id']?>">
                <input name="_csrf" type="hidden" id="_csrf" value="<?= \Yii::$app->request->csrfToken ?>">
                <tr>
                    <td align="right">所需消费</td>
                    <td>
                        <input type="text" name="require_spend" value="<?php echo $coupon['require_spend']?>" size="20" class="inpMain" required=""/>
                    </td>
                </tr>
                <tr>
                    <td align="right">有效期</td>
                    <td>
                        <input name="start_time" class="datainp" id="indate" type="text" placeholder="<?php echo date('Y-m-d',$coupon['start_time'])?>"  readonly>
						<input name="expire_time" class="datainp" id="dateinfo" type="text" placeholder="<?php echo date('Y-m-d',$coupon['expire_time'])?>"  readonly>
                    </td>
                </tr>       
                <tr>
                    <td></td>
