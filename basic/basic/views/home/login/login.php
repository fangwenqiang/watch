...
<div style="width:600px;height:450px; float:left; margin-top:30px;border:1px solid;"><img src="images/gg.jpg" /></div>
...
<input type="text" value="xiyuemingbao" size="35" style="height:30px"/>
</div>
<div style="width:495px;height:80px; float:right;" align="center";>
<span class="STYLE1">密  码</span>：<input type="password" value="12345678"size="35" /style="height:30px"/>
</div>
<div style="width:495px;height:80px; float:right;" align="center";><a href="#"><img src="images/denglu.png"></a><a href="#"><strong> 忘记密码</strong></a></div>
