...
<div id="main2">
    ...
    <div class="rightArea w995">
        <div class="sift_tips">
            ...
            <div class="st_bot">找到&nbsp;“女士手表”&nbsp;<b class="red">18570</b>件</div>
        </div>
        <div class="sift_results">
            <a href="javascript:location.href='/shoubiao.html';" rel="nofollow" title="取消选择“女表”">女表<i>×</i></a></div>
        <!--        根据品牌搜索查询框-->
        <div class="sift_area">
            <div class="sa_mid">
                <div class="floor">
