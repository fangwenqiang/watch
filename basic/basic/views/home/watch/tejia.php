...
<div id="main">
    ...
    <div class="hot_goods_list">
        <div class="context">
            ...
            <ul>
                <li> <span class=""></span> <a href="javascript:void(0)" target="_blank" class="img"><img src="Images/<?=$val['g_img']?>" alt="<?=$val['goods_name']?>" width="300" height="300" /></a>
            ...
            success: function (msg) {
                ...
                if(msg['res'] == '1'){
                    ...
                    $.each(msg.goodsList, function (k,v) {
                        str +='<ul><li> <span class=""></span><a href="javascript:void(0)" target="_blank" class="img"><img src="Images/'+ v.g_img+'" alt="'+v.goods_name+'" width="300" height="300" /></a>';
