        ...
        <tr>
	        <?php foreach ($collect_list as $key => $value): ?>
	        	...
	        	<td>
	        		...
	        		促￥<?php echo $value['market_price'];?>
	        		￥<s><?php echo $value['shop_price'];?></s>
	        	</td>
	        <?php endforeach; ?>
        </tr>
        </table>
    ...
    <div class="leftArea">
        <div class="leftArea">
            ...
            <div class="floor">
                ...
                <div class="c">
                    <ul>
                        ...
                        <li><i class="u__point"></i><a
                                onclick="_gaq.push([&#39;_trackEvent&#39;,&#39;user&#39;,&#39;user_collection&#39;,&#39;/collection&#39;]);"
                                href="<?php echo Url::to(['home/personal/my_collect'])?>" title="我的收藏" class="ccf0" rel="nofollow">我的收藏</a></li>
                        <li><i></i><a
            ...
            <div class="floor">
                ...
                <div class="c">
                    <ul>
                        <li><i class="u__point"></i><a onclick="_gaq.push([&#39;_trackEvent&#39;,&#39;user&#39;,&#39;user_points&#39;,&#39;/points&#39;]);" href="<?php echo Url::to(['home/personal/my_integral'])?>" title="我的积分" rel="nofollow">我的积分</a></li>
